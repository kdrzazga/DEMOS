...
class ScreenWindingAnim:
    ...
    def __init__(self, surface, *, char_size=16, text_color=(51, 255, 102),
        ...
        bajtek_image = self._load_image("bajtek-logo.txt", background_color=1)
        top_secret_image = self._load_image("top-secret-logo.txt", background_color=15)
        ...
        self.walls.add(self._build_text_wall("bajtek.txt", fill_speed, background_color=1, font_color=0), 4.0)
        self.walls.add(self._build_petscii_wall(top_secret_image), 8)
        self.walls.add(self._build_text_wall("top-secret.txt", fill_speed, background_color=15, font_color=4), 4.0)
        self.walls.add(self._build_text_wall("top-secret2.txt", fill_speed, background_color=15, font_color=0), 4.0)
        self.walls.add(self._build_text_wall("top-secret3.txt", fill_speed, background_color=15, font_color=6), 4.0)
        self.walls.add(self._build_text_wall("karate.txt", fill_speed, background_color=0, font_color=self.text_color),4)
        self.walls.add(self._build_petscii_wall(kna_image), 0.5)
