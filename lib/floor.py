...
class JumpingLetter:
    ...
    def __init__(self, x, floor_level, z, texture, height=0.84, speed=0.06,
...
class Floor:
    ...
    HORIZONTAL_LINE = 196
    BALL_CHARS = (113, 48, 79, 143) # PERSCII codes for:ball, empty ball, O,o
